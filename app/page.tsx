...
const services = [
  {
    ...
    imgAlt: "Painter applying paint to interior wall with roller",
    size: "large",
  },
  {
    id: "insulation",
    ...
    imgAlt: "Insulation being installed in ceiling cavity",
    size: "large",
  },
  {
    id: "maintenance",
    ...
    imgAlt: "Tradesperson repairing exterior cladding on a home",
    size: "small",
  },
  {
    id: "handyman",
